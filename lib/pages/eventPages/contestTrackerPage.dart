    ...
    return Container(
      ...
      child: FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          ...
          final int limit = maxByHeight < _previewCount
              ? maxByHeight
              : _previewCount;
          final List<dynamic> preview = contests
              .take(limit)
          ...
          return Column(
            ...
            children: [
              ...
              // Preview list (fixed amount like Events)
              ...preview.map((contest) {
                return Card(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder<dynamic>(
          future: TrackedContests.getContestTrackerData(),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return const Center(
                child: CircularProgressIndicator(color: Colors.orangeAccent),
            ...
            final List<dynamic> contests = snapshot.data['objects'];
            final List<dynamic> filtered = _applySearch(contests);
